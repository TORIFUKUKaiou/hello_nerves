defmodule Qiita.Azure.K8s do
  use Qiita.Azure,
    item_id: "2db585bf7dbe39ed6f5d",
    title: "【毎日自動更新】Azure Kubernetes Serviceに関する記事を投稿しよう！(2021/10/10–2021/11/10) LGTMランキング！",
    event_title: "Azure Kubernetes Serviceに関する記事を投稿しよう！",
    event_url: "https://qiita.com/official-events/8bc3780a142f8ee8effa",
    description: """
