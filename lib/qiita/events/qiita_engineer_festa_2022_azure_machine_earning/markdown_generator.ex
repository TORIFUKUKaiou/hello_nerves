defmodule Qiita.Events.QiitaEngineerFesta2022AzureMachineLearning.MarkdownGenerator do
  ...
  defp template_path do
    "#{:code.priv_dir(:hello_nerves)}/qiita_engineer_festa_2022_azure_machine_earning/template.md"
  end
