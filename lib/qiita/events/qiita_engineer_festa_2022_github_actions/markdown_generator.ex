defmodule Qiita.Events.QiitaEngineerFesta2022GitHubActions.MarkdownGenerator do
  ...
  defp template_path do
    "#{:code.priv_dir(:hello_nerves)}/qiita_engineer_festa_2022_github_actions/template.md"
  end
