defmodule Qiita.Events.QiitaEngineerFesta2022RemoteTestKit.MarkdownGenerator do
  ...
  defp template_path do
    "#{:code.priv_dir(:hello_nerves)}/qiita_engineer_festa_2022_remote_testkit/template.md"
  end
