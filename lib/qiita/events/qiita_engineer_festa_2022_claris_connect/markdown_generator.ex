defmodule Qiita.Events.QiitaEngineerFesta2022ClarisConnect.MarkdownGenerator do
  ...
  defp template_path do
    "#{:code.priv_dir(:hello_nerves)}/qiita_engineer_festa_2022_claris_connect/template.md"
  end
