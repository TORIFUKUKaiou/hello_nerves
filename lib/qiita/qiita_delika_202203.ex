defmodule Qiita.Qiitadelika202203 do
  ...
  def markdown do
    ...
    [Qiita API v2](https://qiita.com/api/v2/docs)を利用させていただいて、「[データに関する記事を書こう！](https://qiita.com/official-events/30be12dd14c0aad2c1c2)」に参加している記事を収拾します。
    あつまった記事（データ）にあれこれしてみます。
