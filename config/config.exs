...
config :hello_nerves, HelloNerves.Scheduler,
  jobs: [
    ...
    {"0 3 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 5 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 7 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 9 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 11 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 13 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 15 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 17 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 19 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 21 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
    {"0 23 * * *", {Qiita.Events.Qiitadelika202203, :run, []}},
